...
about: Load when creating editorial data visualizations for a publication — charts, maps, statistical graphics, and visual story arcs. Accepts article, event cluster, or data release as input. Do NOT load for simple one-off exploratory charts (matplotlib, seaborn, plotly defaults).
---
